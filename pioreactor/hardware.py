...
# PWMs
# Heater PWM
HEATER_PWM_TO_PIN: PwmChannel = "2"
...
NTC_Thermistor_ADDR = 0x48 #CLASHES WITH LR_A, JUST FOR TESTING

# Water Temperature Sensor (10K NTC on A0)
WATER_TEMP_CHANNEL = 0
WATER_TEMP_REF_CHANNEL = 2
WATER_TEMP_R_REF = 10000.0
WATER_TEMP_DATA_RATE = 0x0080  # DR_128SPS - fast, low impedance
WATER_TEMP_STEINHART_A = 0.0007904962
WATER_TEMP_STEINHART_B = 0.0002849790
WATER_TEMP_STEINHART_C = -7.4893966122e-08

# Heater Safety Sensor (100K NTC on A1)
HEATER_TEMP_CHANNEL = 1
HEATER_TEMP_REF_CHANNEL = 2
HEATER_TEMP_R_REF = 20000.0
HEATER_TEMP_DATA_RATE = 0x0020  # DR_16SPS - slow, high impedance needs settling
HEATER_TEMP_STEINHART_A = 0.0007343140544
HEATER_TEMP_STEINHART_B = 0.0002157437229
HEATER_TEMP_STEINHART_C = 0.0000000951582

PH_ADDR = 0x5a  # i2c addr for ph probe
